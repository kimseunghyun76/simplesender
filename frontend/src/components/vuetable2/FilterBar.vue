  ...
  <b-row class="mb-3">
    ...
    <b-col lg="6">
      <b-input-group class="mt-3">
        <date-picker v-model="filtervalue.startDate" :config="config"></date-picker>
        <date-picker v-model="filtervalue.endDate" :config="config"></date-picker>
        <b-form-select v-model="filtervalue.searchName" :options="options" style="width:40px">
        </b-form-select>
